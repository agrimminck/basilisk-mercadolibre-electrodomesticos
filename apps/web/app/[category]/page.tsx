...
import { CategoryFilteredGrid } from '../../components/products/CategoryFilteredGrid'
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[240px_1fr]">
        ...
        <div className="pt-8 pb-14 px-6 lg:pl-8 lg:pr-6">
          <CategoryFilteredGrid products={products} meliUrl={meliUrl} catName={cat.name} iconSeed={iconSeed} />
